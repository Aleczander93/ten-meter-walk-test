...
import { startTimer, stopTimer, saveTime, clearTime } from './reduxFiles/actions'
import { _formatTime } from './reduxFiles/helpers'
...
export class Stopwatch extends React.Component {
  ...
  render () {
    const { saveTime, secondsElapsed, recording } = this.props
    ...
    return (
      <div className='stopwatch'>
        ...
        {saveTime.length > 0 && <LapTimes times={saveTime} />}
      </div>
    )
  }
}
